...
`updated_at` datetime NOT NULL DEFAULT '2021-01-01 00:00:00',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='cucumber表';
...
`updated_at` datetime NOT NULL DEFAULT '2021-01-01 00:00:00',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='food';
...
`updated_at` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='fruit表';
